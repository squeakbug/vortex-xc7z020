...
`define VX_CSR_MPM_SCRB_TEX             12'hB15
`define VX_CSR_MPM_SCRB_TEX_H           12'hB95
`define VX_CSR_MPM_SCRB_OM              12'hB16
`define VX_CSR_MPM_SCRB_OM_H            12'hB96
`define VX_CSR_MPM_SCRB_RASTER          12'hB17
`define VX_CSR_MPM_SCRB_RASTER_H        12'hB97
// PERF: memory
